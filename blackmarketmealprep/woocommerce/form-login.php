...
<?php endif; ?>
		...
		<form class="woocomerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<input style="float: right; border-radius: 20px; background-color: #000; color: #eee; font-family: 'Arimo', sans-serif;" type="submit" class="woocommerce-Button button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div style="padding-right: 8vw;" class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<p class="woocomerce-FormRow form-row">
				...
				<input style="float: right; border-radius: 20px; background-color: #f0b36a; color: #eee; font-family: 'Arimo', sans-serif;" type="submit" class="woocommerce-Button button" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
