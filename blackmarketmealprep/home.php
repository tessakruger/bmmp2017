	...
	<div class="order-container">
		...
		<div class="order-steps-wrapper">
			<div class="order-step-1">
				<img class="order-icon" src="<?php bloginfo('template_url'); ?>/assets/images/ordernow-icon.jpg">
			...
			<div class="order-step-2">
				<img class="order-icon" src="<?php bloginfo('template_url'); ?>/assets/images/customize-meal-icon.jpg">
				<div class="order-step-title">
					Customize Meal
				</div>
				<div class="order-step-description">
			...
			<div class="order-step-3">
				<img class="order-icon" src="<?php bloginfo('template_url'); ?>/assets/images/delivery-icon.jpg">
				<div class="order-step-title">
					Pickup or Delivery?
				</div>
				<div class="order-step-description">
					Save money by picking up your meals from designated pick-up locations, or enter your zip code in your cart to find out if you are eligible for free local delivery or a standard flat rate. Our pick up time is from 6pm to 9pm and our Delivery time is from 4pm - 6pm.
				</div>
			</div>
			<div class="order-step-4">
				<img class="order-icon" src="<?php bloginfo('template_url'); ?>/assets/images/checkout-enjoy-icon.jpg">
				<div class="order-step-title">
					Checkout & Enjoy
				</div>
				<div class="order-step-description">
...
<!-- START CHAR'S SECTION - CSS to be updated -->
